    ...
    <div ref={ref} className="w-[800px] flex gap-4 p-8 bg-gray-50 printable-id-card mx-auto">
      ...
      <div className="w-[340px] h-[540px] bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden relative">
        ...
        <div className="flex justify-center -mt-10 relative z-20">
          <div className="w-32 h-32 bg-white rounded-lg border-4 border-white shadow-md overflow-hidden flex flex-col items-center justify-center">
            {resident.profile_photo ? (
              <img src={`/uploads/photos/${resident.profile_photo}`} alt="Resident" className="w-full h-full object-cover" />
            ) : (
