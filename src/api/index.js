...
export const householdsAPI = {
  ...
  getDeleted: (params) => api.get('/households/deleted', { params }),
  ...
  restore: (id) => api.post(`/households/${id}/restore`),
};
...
export const attendanceAPI = {
  getWorkerQR: (userId) => api.get(`/attendance/worker-qr/${userId}`),
  scanWorker: (data) => api.post('/attendance/scan-worker', data),
