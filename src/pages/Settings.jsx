    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-1 space-y-4 text-sm">
          <button className="w-full flex items-center justify-between p-4 rounded-xl bg-[#2E86C1] text-white shadow-md shadow-[#2E86C1]/20 font-medium transition-transform active:scale-95">
            <span className="flex items-center gap-3"><Users size={18} /> User Management</span>
          </button>
          
          <button className="w-full flex items-center justify-between p-4 rounded-xl bg-white text-gray-600 hover:bg-gray-50 border border-gray-100 font-medium transition-all" onClick={() => alert('Barangay Profile settings are currently managed by developers.')}>
            <span className="flex items-center gap-3"><Building size={18} /> Barangay Profile</span>
          </button>

          <button className="w-full flex items-center justify-between p-4 rounded-xl bg-white text-gray-600 hover:bg-gray-50 border border-gray-100 font-medium transition-all" onClick={() => alert('Security options are managed globally.')}>
